...
$classes = Flux::classes()
    ...
    ->add('disabled:opacity-75 cursor-pointer dark:disabled:opacity-75 disabled:cursor-default disabled:pointer-events-none')
    ->add(match ($size) { // Size...
        'base' => 'h-10 text-sm ' . ' ' . (
            $square
                ? 'w-10'
    ...
    ->add(match ($variant) { // Background color...
        ...
        'underline' => 'bg-white hover:bg-zinc-50 dark:bg-zinc-700 dark:hover:bg-zinc-600/75',
    ...
    ->add(match ($variant) { // Text color...
        ...
        'underline' => 'text-[var(--color-accent-foreground)]',
    ...
    ->add(match ($variant) { // Border color...
        ...
        'underline' => 'border-b-2 border-black dark:border-white ',
    ...
    ->add(match ($variant) { // Shadows...
        ...
        'underline' => 'shadow-[inset_0px_1px_--theme(--color-white/.2)]',
