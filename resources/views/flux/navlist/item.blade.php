...
@php
    ...
    $classes = Flux::classes()
        ->add('h-14 lg:h-12 relative flex items-center gap-3 rounded-lg')
        ->add($square ? 'px-2.5!' : '')
            ...
            match ($variant) {
                'outline' => match ($accent) {
                    true => [
                        ...
                        'data-current:bg-neutral-300 dark:data-current:bg-neutral-700/10 data-current:border data-current:border-zinc-200 dark:data-current:border-transparent',
                    ...
                    false => [
                        ...
                        'data-current:bg-neutral-200 dark:data-current:bg-white/10 data-current:border data-current:border-zinc-200 dark:data-current:border-white/10 data-current:shadow-xs',
...
<flux:button-or-link :attributes="$attributes->class($classes)" data-flux-navlist-item>
    ...
    <div class="flex-1 text-sm text-black dark:text-white font-medium leading-none whitespace-nowrap [[data-nav-footer]_&]:hidden [[data-nav-sidebar]_[data-nav-footer]_&]:block"
